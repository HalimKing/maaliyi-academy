                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countAllTerm;?></span>
                                    </h3>
                        ...
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countAllAdmin;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Admin</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
