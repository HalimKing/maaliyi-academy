...
$query = mysqli_query($con,"select * from tblterm where id='$_SESSION[editid]'");
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"update tblterm set termName='$termName' ,sessionName='$sessionName' where id='$_SESSION[editid]'");
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="termName" type="tel" class="form-control cc-exp" value="<?php echo $rowi['termName'];?>" placeholder="Term/Semester Name">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        echo '
                                                            <select required name="session_name" onchange="showValues(this.value)" class="custom-select form-control">';
                                                        echo'<option value="">--Select Session--</option>
                                                            ';
                                                        while($session_row = mysqli_fetch_array($sql)){
                                                            if($session == $session_row["sessionNamw"]){
                                                                echo '<option selected value="'.$session_row['sessionName'].'"> '.$session_row['sessionName'] .'</option>';
                                                            }else{
