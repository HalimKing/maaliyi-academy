...
$query = mysqli_query($con,"SELECT * FROM tblsubject WHERE courseCode='$_SESSION[editCourseId]'");
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"UPDATE tblsubject SET courseTitle='$courseTitle',courseCode='$courseCode', className='$className',termName='$termName'
                                            ...
                                            <div class="row">
												...
												<!-- Log on to codeastro.com for more projects! -->
                                                    <label for="x_card_code" class="control-label mb-1">Course/Subject Code</label>
                                                        <input id="" name="courseCode" type="text" class="form-control cc-exp" value="<?php echo $rowi['courseCode']  ?>" Required placeholder="Course/Subject Code">
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($count > 0){                       
                                                            ...
                                                            while ($row = mysqli_fetch_array($query)) {
                                                                if($class == $row['levelName']){
                                                                    echo'<option selected value="'.$row['levelName'].'" >'.$row['levelName'].'</option>';
                                                                }else{
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($count > 0){                       
                                                            ...
                                                            while ($row = mysqli_fetch_array($query)) {
                                                                if($term == $row['termName']){
                                                                    echo'<option selected value="'.$row['termName'].'" >'.$row['termName'].'</option>';
                                                                }else{
                                             ...
                                             <!-- <div class="row">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-primary">Update Course/Subject</button>
                                            </div>
                                        </form>
                                    </div>
