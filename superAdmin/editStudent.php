...
if(isset($_POST['submit'])){
  ...
  $levelId=$_POST['levelId'];
    ...
    matricNo='$matricNo', levelId='$levelId', departmentId = '$departmentId', fee='$fee',fee_paid='$fee_paid',fee_balance='$fee_balance', sessionId='$sessionId'
                                       ...
                                       <form method="Post" action="">
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="row">
                                                 <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Fee</label>
                                                    <input id="" name="fee" type="text" class="form-control cc-cvc fee" value="<?php echo $rowi['fee'];?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Fee" readonly style="cursor:no-drop;">
                                                </div>
                                                 <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Fee Paid</label>
                                                    <input id="" name="fee_paid" type="text" class="form-control cc-cvc fee-paid" value="<?php echo $rowi['fee_paid'];?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Fee paid">
                                                </div>
                                             </div>
                                             <div class="row">
                                                 <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Fee Balance</label>
                                                    <input id="" name="fee_balance" type="text" class="form-control cc-cvc fee-balance" value="<?php echo $rowi['fee_balance'];?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Fee balance" readonly style="cursor:no-drop;">
                                                </div>
                                             </div>
