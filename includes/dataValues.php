...
$courseQuery=mysqli_query($con,"select * from tblterm"); //courses
$countAllTerm = mysqli_num_rows($courseQuery);

$courseSession=mysqli_query($con,"select * from tbladmin"); //courses
$countAllAdmin = mysqli_num_rows($courseSession);
